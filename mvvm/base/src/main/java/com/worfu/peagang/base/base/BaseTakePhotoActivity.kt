...
import com.worfu.peagang.base.mvvm.BaseMvvmActivity
import com.worfu.peagang.base.utils.LogUtils
import io.reactivex.Observer
import io.reactivex.disposables.Disposable

/**
 * create by http://me.xuxiao.wang on 2019/4/8 0008 下午 2:09
 * 获取相册照片用
 */
abstract class BaseTakePhotoActivity<T: ViewDataBinding, V: ViewModel> : BaseMvvmActivity<T, V>() {
    ...
    fun cleanCache() {
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(object : Observer<Boolean> {
            ...
            override fun onNext(aBoolean: Boolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(this@BaseTakePhotoActivity)
                } else {
                    Toast.makeText(
